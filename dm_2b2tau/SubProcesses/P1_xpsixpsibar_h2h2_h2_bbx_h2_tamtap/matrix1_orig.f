...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WH2)
      ...
      CALL FFS3_3(W(1,4),W(1,3),GC_62,MDL_MH2, FK_MDL_WH2,W(1,5))
      CALL OXXXXX(P(0,5),MDL_MTA,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_MTA,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS3_3(W(1,3),W(1,4),GC_76,MDL_MH2, FK_MDL_WH2,W(1,6))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_12,GC_10,MDL_MH2, FK_MDL_WH2,W(1
     $ ,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,5),W(1,6),W(1,3),GC_57,AMP(1))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_15,GC_13,MDL_MH1, FK_MDL_WH1,W(1
     $ ,3))
C     Amplitude(s) for diagram number 2
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_59,AMP(2))
      CALL FFS1_2_2(W(1,1),W(1,5),GC_12,GC_10,MDL_MPSI, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFS1_2_0(W(1,3),W(1,2),W(1,6),GC_12,GC_10,AMP(3))
      CALL FFS1_2_2(W(1,1),W(1,6),GC_12,GC_10,MDL_MPSI, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL FFS1_2_0(W(1,3),W(1,2),W(1,5),GC_12,GC_10,AMP(4))
