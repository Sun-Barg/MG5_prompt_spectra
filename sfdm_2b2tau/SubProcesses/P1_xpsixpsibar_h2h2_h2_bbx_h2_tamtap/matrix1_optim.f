...
C     ----------
     ...
     $     *small_width_treatment)), mdl_wh2) 
      ...
      CALL IXXXXX(P(0,4),MDL_MB,+1,-1*IC(4),W(1,7))  !  count 1
      CALL IXXXXX(P(0,4),MDL_MB,-1,-1*IC(4),W(1,8))  !  count 1
      CALL FFS6_3(W(1,7),W(1,5),GC_143,MDL_MH2,FK_MDL_WH2,W(1,9))  !  count 14
      CALL FFS6_3(W(1,8),W(1,6),GC_143,MDL_MH2,FK_MDL_WH2,W(1,10))  !  count 14
