...
C     
C     Process: ~psi ~psibar > b ta- b~ ta+ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL OXXXXX(P(0,3),MDL_MB,+1,+1*IC(3),W(1,5))  !  count 16
      CALL OXXXXX(P(0,3),MDL_MB,-1,+1*IC(3),W(1,6))  !  count 16
      CALL OXXXXX(P(0,4),MDL_MTA,+1,+1*IC(4),W(1,7))  !  count 16
      CALL OXXXXX(P(0,4),MDL_MTA,-1,+1*IC(4),W(1,8))  !  count 16
      CALL IXXXXX(P(0,5),MDL_MB,+1,-1*IC(5),W(1,9))  !  count 16
      CALL IXXXXX(P(0,5),MDL_MB,-1,-1*IC(5),W(1,10))  !  count 16
      CALL IXXXXX(P(0,6),MDL_MTA,+1,-1*IC(6),W(1,11))  !  count 16
      CALL IXXXXX(P(0,6),MDL_MTA,-1,-1*IC(6),W(1,12))  !  count 16
      CALL FFFFFF1P1N_1(W(1,5), W(1,1), W(1,3), W(1,11), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/13,15/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,5), W(1,1), W(1,3), W(1,11), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/9,11/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,5), W(1,1), W(1,3), W(1,12), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/14,16/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,5), W(1,1), W(1,3), W(1,12), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/10,12/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,5), W(1,2), W(1,4), W(1,11), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/29,31/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,5), W(1,2), W(1,4), W(1,11), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/25,27/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,5), W(1,2), W(1,4), W(1,12), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/30,32/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,5), W(1,2), W(1,4), W(1,12), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/26,28/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,1), W(1,3), W(1,11), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,1), W(1,3), W(1,11), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,1), W(1,3), W(1,12), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,1), W(1,3), W(1,12), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,2), W(1,4), W(1,11), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/21,23/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,2), W(1,4), W(1,11), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/17,19/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,2), W(1,4), W(1,12), W(1,7), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/22,24/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF1P1N_1(W(1,6), W(1,2), W(1,4), W(1,12), W(1,8), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/18,20/), 
     & (/9,10/),
