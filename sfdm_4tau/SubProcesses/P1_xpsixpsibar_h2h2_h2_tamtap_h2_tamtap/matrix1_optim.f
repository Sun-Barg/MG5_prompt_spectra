...
C     ----------
     ...
     $     *small_width_treatment)), mdl_wh2) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MPSI,+1,+1*IC(1),W(1,1))  !  count 6
      CALL IXXXXX(P(0,1),MDL_MPSI,-1,+1*IC(1),W(1,2))  !  count 6
      CALL OXXXXX(P(0,2),MDL_MPSI,+1,-1*IC(2),W(1,3))  !  count 10
      CALL OXXXXX(P(0,2),MDL_MPSI,-1,-1*IC(2),W(1,4))  !  count 10
      CALL OXXXXX(P(0,3),MDL_MTA,+1,+1*IC(3),W(1,5))  !  count 1
      CALL OXXXXX(P(0,3),MDL_MTA,-1,+1*IC(3),W(1,6))  !  count 1
      CALL IXXXXX(P(0,4),MDL_MTA,+1,-1*IC(4),W(1,7))  !  count 1
      CALL IXXXXX(P(0,4),MDL_MTA,-1,-1*IC(4),W(1,8))  !  count 1
      CALL FFS6_3(W(1,7),W(1,5),GC_170,MDL_MH2,FK_MDL_WH2,W(1,9))  !  count 14
      CALL FFS6_3(W(1,8),W(1,6),GC_170,MDL_MH2,FK_MDL_WH2,W(1,10))  !  count 14
      CALL OXXXXX(P(0,5),MDL_MTA,+1,+1*IC(5),W(1,11))  !  count 1
      CALL OXXXXX(P(0,5),MDL_MTA,-1,+1*IC(5),W(1,12))  !  count 1
      CALL IXXXXX(P(0,6),MDL_MTA,+1,-1*IC(6),W(1,13))  !  count 1
      CALL IXXXXX(P(0,6),MDL_MTA,-1,-1*IC(6),W(1,14))  !  count 1
      CALL FFS6_3(W(1,13),W(1,11),GC_170,MDL_MH2,FK_MDL_WH2,W(1,15))  !  count 14
      CALL FFS6_3(W(1,14),W(1,12),GC_170,MDL_MH2,FK_MDL_WH2,W(1,16))  !  count 14
      CALL FFS1_2_3(W(1,1),W(1,3),GC_55,GC_13,MDL_MH2,FK_MDL_WH2,W(1,17)
     $)  !  count 4
      CALL FFS1_2_3(W(1,2),W(1,4),GC_55,GC_13,MDL_MH2,FK_MDL_WH2,W(1,18)
     $)  !  count 4
      CALL SSS1P1N_1(W(1,15), W(1,17), GC_137, TMP(1))
      call CombineAmpS(2, 
     &(/4,2/), 
     & (/9,10/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,15), W(1,18), GC_137, TMP(1))
      call CombineAmpS(2, 
     &(/8,6/), 
     & (/9,10/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,16), W(1,17), GC_137, TMP(1))
      call CombineAmpS(2, 
     &(/3,1/), 
     & (/9,10/), 
     & TMP, W, AMP(1,1))
      CALL SSS1P1N_1(W(1,16), W(1,18), GC_137, TMP(1))
      call CombineAmpS(2, 
     &(/7,5/), 
     & (/9,10/), 
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS1_2_3(W(1,1),W(1,3),GC_61,GC_58,MDL_MH1,FK_MDL_WH1,W(1,19)
     $)  !  count 4
      CALL FFS1_2_3(W(1,2),W(1,4),GC_61,GC_58,MDL_MH1,FK_MDL_WH1,W(1,20)
     $)  !  count 4
      CALL SSS1P1N_1(W(1,9), W(1,15), GC_139, TMP(1))
      call CombineAmpS(2, 
     &(/4,8/), 
     & (/19,20/), 
     & TMP, W, AMP(1,2))
      CALL SSS1P1N_1(W(1,9), W(1,16), GC_139, TMP(1))
      call CombineAmpS(2, 
     &(/3,7/), 
     & (/19,20/), 
     & TMP, W, AMP(1,2))
      CALL SSS1P1N_1(W(1,10), W(1,15), GC_139, TMP(1))
      call CombineAmpS(2, 
     &(/2,6/), 
     & (/19,20/), 
     & TMP, W, AMP(1,2))
      CALL SSS1P1N_1(W(1,10), W(1,16), GC_139, TMP(1))
      call CombineAmpS(2, 
     &(/1,5/), 
     & (/19,20/), 
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS1_2_2(W(1,1),W(1,9),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,21))  !  count 2
      CALL FFS1_2_2(W(1,1),W(1,10),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,22))
     $  !  count 2
      CALL FFS1_2_2(W(1,2),W(1,9),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,23))  !  count 2
      CALL FFS1_2_2(W(1,2),W(1,10),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,24))
     $  !  count 2
      CALL FFS1_2P1N_1(W(1,3), W(1,15), GC_55, GC_13, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))
      CALL FFS1_2P1N_1(W(1,3), W(1,16), GC_55, GC_13, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,3))
      CALL FFS1_2P1N_1(W(1,4), W(1,15), GC_55, GC_13, TMP(1))
      call CombineAmp(2,
     & (/8,6/), 
     & (/23,24/),
     & TMP, W, AMP(1,3))
      CALL FFS1_2P1N_1(W(1,4), W(1,16), GC_55, GC_13, TMP(1))
      call CombineAmp(2,
     & (/7,5/), 
     & (/23,24/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS1_2_2(W(1,1),W(1,15),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,25))
     $  !  count 2
      CALL FFS1_2_2(W(1,1),W(1,16),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,26))
     $  !  count 2
      CALL FFS1_2_2(W(1,2),W(1,15),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,27))
     $  !  count 2
      CALL FFS1_2_2(W(1,2),W(1,16),GC_55,GC_13,MDL_MPSI,FK_ZERO,W(1,28))
     $  !  count 2
