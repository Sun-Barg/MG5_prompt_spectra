...
C     
C     Process: ~psi ~psibar > h2 > b b~ WEIGHTED<=3 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_wh2) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MPSI,+1,+1*IC(1),W(1,1))  !  count 1
      CALL IXXXXX(P(0,1),MDL_MPSI,-1,+1*IC(1),W(1,2))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MPSI,+1,-1*IC(2),W(1,3))  !  count 1
      CALL OXXXXX(P(0,2),MDL_MPSI,-1,-1*IC(2),W(1,4))  !  count 1
      ...
      CALL FFS1_2_3(W(1,1),W(1,3),GC_55,GC_13,MDL_MH2,FK_MDL_WH2,W(1,9))
     $  !  count 2
      CALL FFS1_2_3(W(1,2),W(1,4),GC_55,GC_13,MDL_MH2,FK_MDL_WH2,W(1,10)
     $)  !  count 2
      CALL FFS6_0(W(1,7),W(1,5),W(1,9),GC_143,AMP(2,1))
      CALL FFS6_0(W(1,7),W(1,5),W(1,10),GC_143,AMP(4,1))
      CALL FFS6_0(W(1,8),W(1,6),W(1,9),GC_143,AMP(1,1))
      CALL FFS6_0(W(1,8),W(1,6),W(1,10),GC_143,AMP(3,1))  !  count 1
