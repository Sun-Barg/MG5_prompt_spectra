...
C     ----------
     ...
     $     *small_width_treatment)), mdl_wh2) 
      ...
      CALL OXXXXX(P(0,5),MDL_MB,+1,+1*IC(5),W(1,11))  !  count 1
      CALL OXXXXX(P(0,5),MDL_MB,-1,+1*IC(5),W(1,12))  !  count 1
      CALL IXXXXX(P(0,6),MDL_MB,+1,-1*IC(6),W(1,13))  !  count 1
      CALL IXXXXX(P(0,6),MDL_MB,-1,-1*IC(6),W(1,14))  !  count 1
      CALL FFS6_3(W(1,13),W(1,11),GC_143,MDL_MH2,FK_MDL_WH2,W(1,15))  !  count 14
      CALL FFS6_3(W(1,14),W(1,12),GC_143,MDL_MH2,FK_MDL_WH2,W(1,16))  !  count 14
