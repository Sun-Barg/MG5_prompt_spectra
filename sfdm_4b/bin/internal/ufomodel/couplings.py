...
GC_59 = Coupling(name = 'GC_59',
                 value = '2*CTH*complex(0,1)*lam*STH',
                 order = {'QED':2})
...
GC_105 = Coupling(name = 'GC_105',
                  value = '-0.5*(CTH*cw*ee)/sw - (CTH*ee*sw)/(2.*cw)',
                  order = {'QED':1})
...
GC_107 = Coupling(name = 'GC_107',
                  value = '(cw*ee*STH)/(2.*sw) + (ee*STH*sw)/(2.*cw)',
                  order = {'QED':1})
...
GC_115 = Coupling(name = 'GC_115',
                  value = '-2*CTH*complex(0,1)*lam*vev',
                  order = {'QED':2})
...
GC_117 = Coupling(name = 'GC_117',
                  value = '2*complex(0,1)*lam*STH*vev',
                  order = {'QED':2})
...
GC_123 = Coupling(name = 'GC_123',
                  value = '-0.25*(CTH*ee**2*complex(0,1)*vev)/sw**2',
                  order = {'QED':2})
...
GC_125 = Coupling(name = 'GC_125',
                  value = '(ee**2*complex(0,1)*STH*vev)/(4.*sw**2)',
                  order = {'QED':2})
...
GC_133 = Coupling(name = 'GC_133',
                  value = '-0.5*(CTH*ee**2*complex(0,1)*vev) - (CTH*cw**2*ee**2*complex(0,1)*vev)/(4.*sw**2) - (CTH*ee**2*complex(0,1)*sw**2*vev)/(4.*cw**2)',
                  order = {'QED':2})
...
GC_135 = Coupling(name = 'GC_135',
                  value = '(ee**2*complex(0,1)*STH*vev)/2. + (cw**2*ee**2*complex(0,1)*STH*vev)/(4.*sw**2) + (ee**2*complex(0,1)*STH*sw**2*vev)/(4.*cw**2)',
                  order = {'QED':2})
