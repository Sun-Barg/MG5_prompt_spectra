...
V_19 = Vertex(name = 'V_19',
              particles = [ P.P__tilde__psibar, P.P__tilde__psi, P.h2 ],
              color = [ '1' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_12,(0,1):C.GC_10})

V_20 = Vertex(name = 'V_20',
              particles = [ P.P__tilde__psibar, P.P__tilde__psi, P.h1 ],
              color = [ '1' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_15,(0,1):C.GC_13})

V_21 = Vertex(name = 'V_21',
              particles = [ P.b__tilde__, P.b, P.b__tilde__, P.b, P.P__tilde__psibar, P.P__tilde__psi ],
              color = [ 'Identity(1,2)*Identity(3,4)', 'Identity(1,4)*Identity(2,3)' ],
              lorentz = [ L.FFFFFF1, L.FFFFFF2 ],
              couplings = {(1,0):C.GC_9,(0,1):C.GC_9})
...
V_107 = Vertex(name = 'V_107',
               ...
               couplings = {(0,0):C.GC_39,(0,1):C.GC_44})
