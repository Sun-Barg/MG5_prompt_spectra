...
C     
C     Process: ~psi ~psibar > b b~ b b~ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MPSI,+1,+1*IC(1),W(1,1))  !  count 32
      CALL IXXXXX(P(0,1),MDL_MPSI,-1,+1*IC(1),W(1,2))  !  count 32
      CALL OXXXXX(P(0,2),MDL_MPSI,+1,-1*IC(2),W(1,3))  !  count 32
      CALL OXXXXX(P(0,2),MDL_MPSI,-1,-1*IC(2),W(1,4))  !  count 32
      CALL OXXXXX(P(0,3),MDL_MB,+1,+1*IC(3),W(1,5))  !  count 32
      CALL OXXXXX(P(0,3),MDL_MB,-1,+1*IC(3),W(1,6))  !  count 32
      CALL IXXXXX(P(0,4),MDL_MB,+1,-1*IC(4),W(1,7))  !  count 32
      CALL IXXXXX(P(0,4),MDL_MB,-1,-1*IC(4),W(1,8))  !  count 32
      CALL OXXXXX(P(0,5),MDL_MB,+1,+1*IC(5),W(1,9))  !  count 32
      CALL OXXXXX(P(0,5),MDL_MB,-1,+1*IC(5),W(1,10))  !  count 32
      CALL IXXXXX(P(0,6),MDL_MB,+1,-1*IC(6),W(1,11))  !  count 32
      CALL IXXXXX(P(0,6),MDL_MB,-1,-1*IC(6),W(1,12))  !  count 32
      CALL FFFFFF2P1N_1(W(1,5), W(1,11), W(1,9), W(1,1), W(1,3), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/11,15/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,5), W(1,11), W(1,9), W(1,2), W(1,4), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/27,31/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,5), W(1,11), W(1,10), W(1,1), W(1,3), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/9,13/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,5), W(1,11), W(1,10), W(1,2), W(1,4), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/25,29/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,5), W(1,12), W(1,9), W(1,1), W(1,3), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/12,16/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,5), W(1,12), W(1,9), W(1,2), W(1,4), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/28,32/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,5), W(1,12), W(1,10), W(1,1), W(1,3), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/10,14/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,5), W(1,12), W(1,10), W(1,2), W(1,4), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/26,30/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,11), W(1,9), W(1,1), W(1,3), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,11), W(1,9), W(1,2), W(1,4), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/19,23/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,11), W(1,10), W(1,1), W(1,3), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,11), W(1,10), W(1,2), W(1,4), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/17,21/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,12), W(1,9), W(1,1), W(1,3), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,12), W(1,9), W(1,2), W(1,4), GC_9, T
     $MP(1))
      call CombineAmp(2,
     & (/20,24/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,12), W(1,10), W(1,1), W(1,3), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFFFF2P1N_1(W(1,6), W(1,12), W(1,10), W(1,2), W(1,4), GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/18,22/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFFFFF1P1N_1(W(1,5), W(1,11), W(1,9), W(1,1), W(1,3), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/11,15/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,5), W(1,11), W(1,9), W(1,2), W(1,4), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/27,31/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,5), W(1,11), W(1,10), W(1,1), W(1,3), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/9,13/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,5), W(1,11), W(1,10), W(1,2), W(1,4), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/25,29/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,5), W(1,12), W(1,9), W(1,1), W(1,3), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/12,16/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,5), W(1,12), W(1,9), W(1,2), W(1,4), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/28,32/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,5), W(1,12), W(1,10), W(1,1), W(1,3), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/10,14/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,5), W(1,12), W(1,10), W(1,2), W(1,4), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/26,30/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,11), W(1,9), W(1,1), W(1,3), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,11), W(1,9), W(1,2), W(1,4), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/19,23/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,11), W(1,10), W(1,1), W(1,3), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,11), W(1,10), W(1,2), W(1,4), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/17,21/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,12), W(1,9), W(1,1), W(1,3), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,12), W(1,9), W(1,2), W(1,4), -GC_9, 
     $TMP(1))
      call CombineAmp(2,
     & (/20,24/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,12), W(1,10), W(1,1), W(1,3), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFFFF1P1N_1(W(1,6), W(1,12), W(1,10), W(1,2), W(1,4), -GC_9,
     $ TMP(1))
      call CombineAmp(2,
     & (/18,22/), 
     & (/7,8/),
